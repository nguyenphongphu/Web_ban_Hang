$.fn.upload = function (parameters) {
    ...
    var uploadfinish = function (imageURL) {
        ...
        $('#' + instanceID + ' .working-upload-item').append('<span><img src="' + defaults.serverThumb + '/' + imageURL + '"></span>');
    ...
    var uploadItemTemplate = '<li><div class="upload-item working-upload-item upload"><a class="browse-img-upload" href="javascript:;"><i class="icon-picture"></i>Tải ảnh lên</a></div></li>';
    ...
    var actionItemTemplate = '<a href="javascript:void(0)" class="upload-item-delete delete-img-upload"><i class="icon-trash-empty"></i></a>';
