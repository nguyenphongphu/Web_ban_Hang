...
!function (l) {
    "use strict";
    l("#sidebarToggleaa").on("click",
    l('#AlertBox').removeClass('hide'),
    l('#AlertBox').delay(1000).slideUp(500),
        function (o) {
        ...
        function (o) {
            var e = l(this); l("html, body").stop().animate({ scrollTop: l(e.attr("href")).offset().top }, 1e3, "easeInOutExpo"), o.preventDefault()
        })
}(jQuery);